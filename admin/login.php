<?php 
	...
	if(isset($_POST['login'])) {
		...
		if(!isset($error['email']) && !isset($error['password'])) { //!false && !false
			...
			$sqlLogin = "SELECT * FROM user WHERE user_mail = '$email' && user_pass='$password'";
...
<title>SHOP ĐỒ CỔ - Administrator</title>
	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading">SHOP ĐỒ CỔ - Administrator</div>
