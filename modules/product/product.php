...
?>
<!--	List Product	-->
<div style="margin-top:30px" id="product">
    <div id="product-head" class="row">
        <div id="product-img" class="col-lg-3 col-md-3 col-sm-12">
            <img style="width:200px" src="admin/images/<?php echo $product['prd_image']; ?>">
        </div>
        <div id="product-details" class="col-lg-3 col-md-3 col-sm-12">
